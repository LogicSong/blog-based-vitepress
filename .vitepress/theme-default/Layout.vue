  ...
  data() {
    return {
      ...
      cardConfig: {
        ...
        nickName: "Syp",
        skill:
          "精通 CSS、JavaScript、PHP、ASP、C、C++、C#、Java、Ruby、Perl、Lisp、Python、Objective-C、ActionScript、Pascal 等单词的拼写，熟悉 Windows、Linux、OS X、Android、iOS、WP8 等系统的开关机。",
        synopsis:
          "专注于潜水、摸鱼、搬砖。毕业两年，终于找到一点编程的乐趣",
      },
    };
  },
  methods: {
